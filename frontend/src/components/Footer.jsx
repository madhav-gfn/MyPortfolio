...
const Footer = () => {
  ...
  return (
    <footer className="relative z-10 bg-white dark:bg-black border-t-2 border-black dark:border-white mt-20">
              ...
              >
                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                  ...
                  <a
                    ...
                    className="cursor-target text-gray-600 dark:text-gray-400 hover:text-red-500 transition-colors"
                  >
              ...
              <ul className="space-y-3">
                {quickLinks.map((link, index) => (
                  ...
                  >
                    <Link
                      to={link.path}
                      className="cursor-target text-gray-600 dark:text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center gap-2 group"
                    >
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="cursor-target w-10 h-10 bg-white dark:bg-black border-2 border-black dark:border-white rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-red-500 hover:border-red-500 transition-all duration-200"
